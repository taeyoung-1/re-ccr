...
Section SIMMODSEM.
  ...
  Proof.
    ...
    { unfold Echo0.echo_body, echo_body, cfunN, cfunU, ccallN, ccallU.
      ...
      post_call. steps_safe. astop. steps_safe. erewrite STBINCL; cycle 1. { stb_tac; ss. } steps_safe.
      hcall _ _ with "A"; ss; et.
      { iModIntro. iSplits; ss; et. }
      post_call. steps_safe. astop. steps_safe.
      erewrite STBINCL; cycle 1. { stb_tac; ss. } steps_safe.
      hcall _ _ with "A"; ss; et.
      { iModIntro. iSplits; ss; et. }
