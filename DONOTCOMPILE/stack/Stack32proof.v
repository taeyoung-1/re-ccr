...
Section REFINE.
  ...
  Theorem correct: refines2 [SMod.to_src Stack3A.SStack] [Stack2.Stack].
  Proof.
    eapply adequacy_local2. econs; ss. i.
    econstructor 1 with (wf:=wf) (le:=top2); ss.
    2: { esplits; et. ss. }
    econs; ss.
    { init. unfold cfunU, fun_to_src, Stack2.new_body, new_body, body_to_src.
      red in WF. des; clarify. steps. force_l. eexists. steps. force_l; et.
      steps. red. esplits; et. red. esplits; et.  
    }
    econs; ss.
    { init. unfold cfunU, fun_to_src, Stack2.pop_body, pop_body, body_to_src.
    ...
    econs; ss.
    { init. unfold cfunU, fun_to_src, Stack2.push_body, push_body, body_to_src.
      red in WF. des; clarify.
