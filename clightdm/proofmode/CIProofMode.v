...
Section MEM.
        ...
        (inv_with le I w0 st_src st_tgt
                  ** 
                  (∀ st_src st_tgt vaddr m,
                      ((inv_with le I w0 st_src st_tgt) ** (⌜m.(sz) = Z.of_nat n⌝ ** vaddr ↦m#1≻ List.repeat Undef n ** vaddr ⊨m#1≖ (0, Local))) -* isim le I mn stb o (g, g, true, true) Q (Some fuel1) (st_src, itr_src) (st_tgt, ktr_tgt (m.(blk)))))
  ...
  Lemma isim_ccallU_sfree
    ...
    :
      bi_entails
        (inv_with le I w0 st_src st_tgt
                  ** (∃ m mvl vaddr, vaddr ↦m#1≻ mvl ** vaddr ⊨m#1≖ (0, Local) ** ⌜m.(blk) = b /\ m.(sz) = size /\ Z.of_nat (List.length mvl) = m.(sz)⌝)
                  **
                  (∀ st_src st_tgt,
  ...
  Lemma isim_ccallU_load
    ...
    :
      bi_entails
        (inv_with le I w0 st_src st_tgt
                  ** (vaddr ↦m#q≻ mvs ** ⌜List.length mvs = size_chunk_nat chunk⌝)
                  **
                  (∀ st_src st_tgt,
  ...
  Lemma isim_ccallU_store
    ...
    :
      bi_entails
        (inv_with le I w0 st_src st_tgt
                  ** (∃ mvs_old, ⌜length mvs_old = size_chunk_nat chunk⌝ ** vaddr ↦m#1≻ mvs_old)
                  **
                  (∀ st_src st_tgt,
  ...
  Lemma isim_ccallU_cmp_ptr1
    ...
    :
      bi_entails
        (inv_with le I w0 st_src st_tgt
                  ** (⌜weak_valid m ofs⌝ ** vaddr ⊨m#q≖ (ofs, tg))
                  **
                  (∀ st_src st_tgt,
                      ((inv_with le I w0 st_src st_tgt) ** (vaddr ⊨m#q≖ (ofs, tg))) -* isim le I mn stb o (g, g, true, true) Q (Some fuel1) (st_src, itr_src) (st_tgt, ktr_tgt false)))
    ...
    :
      bi_entails
        (inv_with le I w0 st_src st_tgt
                  ...
                  **
                  (∀ st_src st_tgt,
                      ((inv_with le I w0 st_src st_tgt) ** (vaddr ⊨m#q≖ (ofs, tg))) -* isim le I mn stb o (g, g, true, true) Q (Some fuel1) (st_src, itr_src) (st_tgt, ktr_tgt true)))
  ...
  Lemma isim_ccallU_cmp_ptr5
        ...
        (Q: Any.t -> Any.t -> R_src -> R_tgt -> iProp)
        r g f_src f_tgt st_src st_tgt
        vaddr0 vaddr1 c m ofs0 ofs1 q0 q1 tg0 tg1
    ...
    :
      bi_entails
        (inv_with le I w0 st_src st_tgt
                  ...
                  **
                  (∀ st_src st_tgt,
                      ((inv_with le I w0 st_src st_tgt) ** (vaddr0 ⊨m#q0≖ (ofs0, tg0) ** vaddr1 ⊨m#q1≖ (ofs1, tg1))) -* isim le I mn stb o (g, g, true, true) Q (Some fuel1) (st_src, itr_src) (st_tgt, ktr_tgt (cmp_ofs c ofs0 ofs1))))
    ...
    :
      bi_entails
        (inv_with le I w0 st_src st_tgt
                  ...
                  **
                  (∀ st_src st_tgt,
                      ((inv_with le I w0 st_src st_tgt) ** (vaddr0 ⊨m0#q0≖ (ofs0, tg0) ** vaddr1 ⊨m1#q1≖ (ofs1, tg1))) -* isim le I mn stb o (g, g, true, true) Q (Some fuel1) (st_src, itr_src) (st_tgt, ktr_tgt false)))
    ...
    :
      bi_entails
        (inv_with le I w0 st_src st_tgt
                  ...
                  **
                  (∀ st_src st_tgt,
                      ((inv_with le I w0 st_src st_tgt) ** (vaddr0 ⊨m0#q0≖ (ofs0, tg0) ** vaddr1 ⊨m1#q1≖ (ofs1, tg1))) -* isim le I mn stb o (g, g, true, true) Q (Some fuel1) (st_src, itr_src) (st_tgt, ktr_tgt true)))
  ...
  Lemma isim_ccallU_sub_ptr
        ...
        (Q: Any.t -> Any.t -> R_src -> R_tgt -> iProp)
        r g f_src f_tgt st_src st_tgt
        size vaddr0 vaddr1 m ofs0 ofs1 q0 q1 tg0 tg1
    ...
    :
      bi_entails
        (inv_with le I w0 st_src st_tgt
                  ...
                  **
                  (∀ st_src st_tgt,
                      ((inv_with le I w0 st_src st_tgt) ** (vaddr0 ⊨m#q0≖ (ofs0, tg0) ** vaddr1 ⊨m#q1≖ (ofs1, tg1))) -* isim le I mn stb o (g, g, true, true) Q (Some fuel1) (st_src, itr_src) (st_tgt, ktr_tgt (Vptrofs (Ptrofs.repr (Z.div (ofs0 - ofs1) size))))))
    ...
    :
      bi_entails
        (inv_with le I w0 st_src st_tgt
                  ...
                  **
                  (∀ st_src st_tgt vaddr m,
                      ((inv_with le I w0 st_src st_tgt) ** (⌜m.(sz) = Ptrofs.unsigned n⌝ ** vaddr ↦m#1≻ List.repeat Undef (Z.to_nat (Ptrofs.unsigned n)) ** vaddr ⊨m#1≖ (0, Dynamic))) -* isim le I mn stb o (g, g, true, true) Q (Some fuel1) (st_src, itr_src) (st_tgt, ktr_tgt vaddr)))
  ...
  Lemma isim_ccallU_mfree
    ...
    :
      bi_entails
        (inv_with le I w0 st_src st_tgt
                  ** (∃ m mvl, vaddr ↦m#1≻ mvl ** vaddr ⊨m#1≖ (0, Dynamic) ** ⌜Z.of_nat (List.length mvl) = m.(sz)⌝)
                  **
                  (∀ st_src st_tgt,
    ...
    :
      bi_entails
        (inv_with le I w0 st_src st_tgt
                  ...
                  **
                  (∀ st_src st_tgt i,
                      (((inv_with le I w0 st_src st_tgt) ** (vaddr ⊨m#q≖ (ofs, tg) ** vaddr (≃_m) (Ptrofs.unsigned i))) -* isim le I mn stb o (g, g, true, true) Q (Some fuel1) (st_src, itr_src) (st_tgt, ktr_tgt (Vptrofs i)))))
