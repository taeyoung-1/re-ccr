...
Section ADEQUACY.
Hypothesis (SIM: simg eq false false (@ModSemL.initial_itr ms_src CONFS (Some (ModL.wf_bool md_src))) (@ModSemL.initial_itr ms_tgt CONFT (Some (ModL.wf_bool md_tgt)))).
